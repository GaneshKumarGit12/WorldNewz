    ...
    <>
      ...
      >
        ...
        {currentScreen === "tutorial" && (
          ...
          >
            <Typography variant="h5" fontWeight="900" color="#a855f7" mb={2}>
              How to Play
            </Typography>

            <Typography variant="body1" sx={{ color: "#cbd5e1", mb: 3, px: 1, lineHeight: 1.6 }}>
              Merge identical cubes to grow! Use your mouse pointer or touch-drag to steer. Consume smaller snakes to absorb their blocks, but watch out for division signs `(÷)` or larger enemies!
            </Typography>
            ...
            >
              <Box display="flex" justifyContent="center" alignItems="center" gap={2}>
                <Box sx={{ bg: "#e2e8f0", color: "#334155", p: 1.5, borderRadius: "8px", fontWeight: "bold" }}>2</Box>
                <ArrowBackIcon sx={{ color: "#a855f7", transform: "rotate(180deg)" }} />
                <Box sx={{ bg: "#fde68a", color: "#92400e", p: 1.5, borderRadius: "8px", fontWeight: "bold" }}>4</Box>
              </Box>
              <Box display="flex" alignItems="center" gap={1}>
                <MouseIcon sx={{ color: "#ec4899", fontSize: 18 }} />
                <Typography variant="caption" color="textSecondary">Move mouse or drag to steer</Typography>
              </Box>
            </Box>
          ...
          <Box sx={{ width: "100%", height: { xs: "72vh", md: "80vh" }, display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              <Box display="flex" alignItems="center" gap={1.2}>
                ...
                <Typography variant="h5" fontWeight="950" sx={{ color: "#a855f7" }}>
                  {score}
                </Typography>
              </Box>
              ...
              <Box sx={{ width: 140, display: { xs: "none", sm: "block" } }}>
                <Box display="flex" justifyContent="space-between" mb={0.25}>
                  <Typography variant="caption" sx={{ color: "#94a3b8" }}>Sprint</Typography>
                  <Typography variant="caption" fontWeight="bold" color="#ec4899">{Math.floor(boostCooldown)}%</Typography>
                </Box>
                ...
                <Table size="small">
                  ...
                  <TableBody>
                    {leaderboard.map((row, idx) => {
                      ...
                      return (
                        <TableRow key={row.id} sx={{ "&:hover": { background: "rgba(255,255,255,0.03)" } }}>
                          <TableCell sx={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                            {isTop3 ? <StarIcon sx={{ color: colors[idx], fontSize: 16 }} /> : idx + 1}
                          </TableCell>
                          <TableCell sx={{ fontWeight: isTop3 ? "800" : "500", color: "#fff", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                            {row.username}
                          </TableCell>
                          <TableCell align="right" sx={{ fontWeight: "800", color: isTop3 ? "#ec4899" : "#a855f7", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                            {row.points}
                          </TableCell>
                        </TableRow>
                      );
