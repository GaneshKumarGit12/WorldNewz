...
def resolve_single_url(raw_url, seen_asins, existing_csharp_asins, seen_images, seen_titles):
    ...
    cat_keywords = {
        ...
        "Health & Fitness": ["protein", "supplement", "vitamin", "dumbbells", "yoga", "fitness", "massager", "hot water bag", "foot patch", "eye mask", "reading glasses", "hand wrap", "knee support", "weight", "shaker", "bandage", "brace", "gym", "exercise", "resistance band", "incline", "barbell", "glucometer", "thermometer", "nebulizer", "weighing scale", "orthopedic", "diaper", "cycle", "sweat belt", "diabetic", "diabetes"],
        "Toys & Games": ["squishy toy", "fidget toy", "toy knife", "novelty", "taba squeeze", "puzzle", "action figure", "pencil box", "lcd writing pad", "drawing board", "balloon", "decoration kit", "birthday", "toy", "game", "doll", "car toy", "board game", "cards", "lego", "building block", "glitter tape", "art and craft", "alphabet book", "soft toy"]
    }
    lower_t = title.lower()
