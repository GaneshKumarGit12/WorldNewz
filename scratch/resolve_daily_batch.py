...
urls = [
    "https://link.amazon/B0ivJ66ID",
    "https://link.amazon/B0gtTKJvi",
    "https://link.amazon/B0damwOwn",
    "https://link.amazon/B0bEdcl2j",
    "https://link.amazon/B04BK6fVI",
    "https://link.amazon/B09NkdK1b",
    "https://link.amazon/B0dDsFdJi",
    "https://link.amazon/B04tLkCVN",
    "https://link.amazon/B0gwqUhoz",
    "https://link.amazon/B07w0uHgz",
    "https://link.amazon/B01JanJX1",
    "https://link.amazon/B0amUogvs",
    "https://link.amazon/B03ln6nxd",
    "https://link.amazon/B0bzfPtNS",
    "https://link.amazon/B0144HUaj",
    "https://link.amazon/B03AChOiX",
    "https://link.amazon/B0iHzlitI",
    "https://link.amazon/B0bnQ1l94",
    "https://link.amazon/B01RHrNH4",
    "https://link.amazon/B00ePDlfL",
    "https://link.amazon/B07P5ErCV",
    "https://link.amazon/B02qThZFj",
    "https://link.amazon/B0cZuVdO1",
    "https://link.amazon/B0etizP1z",
    "https://link.amazon/B05gwtFei",
    "https://link.amazon/B02SuyEtU",
    "https://link.amazon/B0e6xzxhI",
    "https://link.amazon/B0fpdEIq3",
    "https://link.amazon/B0iJENOGx",
    "https://link.amazon/B0cPlxB1x",
    "https://link.amazon/B02wivXVp",
    "https://link.amazon/B04h6rB7Y",
    "https://link.amazon/B01fwsmOd",
    "https://link.amazon/B0233BaOF",
    "https://link.amazon/B0fqahUaG",
    "https://link.amazon/B0396QrOj",
    "https://link.amazon/B04qljf2I",
    "https://link.amazon/B01oVw2SQ",
    "https://link.amazon/B00xEylQ5",
    "https://link.amazon/B07ES2yz0",
    "https://link.amazon/B00EkSYqa",
    "https://link.amazon/B04AeX6qN",
    "https://link.amazon/B07gRM3B8",
    "https://link.amazon/B0fu95pOk",
    "https://link.amazon/B0gt9VyJk",
    "https://link.amazon/B0iiUwYOz",
    "https://link.amazon/B05oVJ7NI",
    "https://link.amazon/B0d5i7IFn",
    "https://link.amazon/B0eR5ZW0t",
    "https://link.amazon/B0at19Fxs",
    "https://link.amazon/B08qzQHeS",
    "https://link.amazon/B0bMNTS6h",
    "https://link.amazon/B0hSItLWV",
    "https://link.amazon/B05mq7QSR",
    "https://link.amazon/B07bdyaMv",
    "https://link.amazon/B07WUe7Yc",
    "https://link.amazon/B05lxcd5c",
    "https://link.amazon/B0dloXEJl",
    "https://link.amazon/B0d6sBqQs",
    "https://link.amazon/B07oGYc6a",
    "https://link.amazon/B0cCw2kcQ",
    "https://link.amazon/B07pcALDz",
    "https://link.amazon/B0biPGvFv",
    "https://link.amazon/B03RjPlcQ",
    "https://link.amazon/B0513lvES",
    "https://link.amazon/B0iFRKFcu",
    "https://link.amazon/B05kod7ks",
    "https://link.amazon/B06Xl5uGI",
    "https://link.amazon/B0ajgicXS",
    "https://link.amazon/B0bUvVEQ7",
    "https://link.amazon/B0fg6iG2b",
    "https://link.amazon/B05PLqxlg",
    "https://link.amazon/B0cExZjlq",
    "https://link.amazon/B0bgW7N1V",
    "https://link.amazon/B0e16Rnf9",
    "https://link.amazon/B0cUWY6Mq",
    "https://link.amazon/B05leGrht",
    "https://link.amazon/B0gXWKpHI"
]
            ...
            with opener.open(u, timeout=12) as resp:
                ...
                if not img_url:
                    ...
                    for m_img in main_dyn:
                        if not any(x in m_img for x in ['PKmb-play', 'sprite', 'icon', 'logo', 'G/01', 'G/31', 'SX38', 'SY50', 'SR38', 'SR50']):
                            img_url = m_img
                            break
                if not img_url:
                ...
                if title and img_url:
                    ...
                    t_lower = title.lower()
                    if any(k in t_lower for k in ['phone', 'mobile', 'charger', 'cable', 'headphone', 'earbuds', 'laptop', 'smartwatch', 'tv', 'electronics', 'speaker', 'led', 'pro', 'wifi', 'watch', 'camera', 'ups', 'router', 'adapter', 'cable', 'battery', 'memory', 'keyboard', 'mouse', 'usb', 'spoiler', 'drill', 'cordless', 'lighter', 'gadget', 'bluetooth']):
                        category = "Technology"
                    elif any(k in t_lower for k in ['shirt', 'pant', 'shoes', 'dress', 'bag', 'fashion', 'wear', 't-shirt', 'wallet', 'kurta', 'suit', 'saree', 'trolley', 'mattress', 'bed', 'sofa', 'pajama', 'nightsuit', 'lungi', 'dupatta', 'sandal', 'heel', 'bangles', 'jewel', 'necklace', 'earring', 'perfume', 'attar', 'skirt', 'bra', 'loafer', 'sweater', 'vest', 'ring', 'slipper', 'sandals', 'jhumka']):
                        category = "Lifestyle"
                    elif any(k in t_lower for k in ['kitchen', 'home', 'bottle', 'cookware', 'clean', 'mat', 'light', 'furnishing', 'storage', 'rakhi', 'vacuum', 'juice', 'cloth', 'glass', 'mug', 'cup', 'idol', 'frame', 'pebbles', 'stones', 'trivet', 'towel', 'detergent', 'plant', 'succulent', 'curtain', 'diwan', 'scented', 'candle', 'tea', 'seeds', 'jug', 'scrubber', 'spoon', 'dabba', 'ghee', 'oil', 'organizer', 'sponge', 'mop', 'brush', 'umbrella', 'luggage', 'cooker', 'pan', 'peeler', 'grater']):
                        category = "Shopping"
                    elif any(k in t_lower for k in ['sport', 'fit', 'gym', 'cycle', 'ball', 'run', 'yoga', 'paddle', 'racket', 'band', 'racket', 'knee', 'teether', 'game', 'toy', 'spin', 'brace', 'bike', 'valve', 'massager', 'foot pad', 'spinner']):
                        category = "Sports"
                    else:
                        category = "Shopping"
