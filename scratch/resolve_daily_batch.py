...
urls = [
    "https://link.amazon/B0a0agCzU",
    "https://link.amazon/B0i4RtENI",
    "https://link.amazon/B0eBU5sF8",
    "https://link.amazon/B0ejcnYjW",
    "https://link.amazon/B040xDUV2",
    "https://link.amazon/B00xfTWzE",
    "https://link.amazon/B0dqsM1gE",
    "https://link.amazon/B05eSi1s7",
    "https://link.amazon/B05dC3yAm",
    "https://link.amazon/B0iEo9BzB",
    "https://link.amazon/B07oTeQ3i",
    "https://link.amazon/B0izUo0wb",
    "https://link.amazon/B05wrwkJC",
    "https://link.amazon/B0ipXAOoV",
    "https://link.amazon/B0dv0bwR8",
    "https://link.amazon/B0eWNPilO",
    "https://link.amazon/B0jli16yi",
    "https://link.amazon/B09l0boeG",
    "https://link.amazon/B02wD3uHK",
    "https://link.amazon/B09hjicEp",
    "https://link.amazon/B0aQxyJoc",
    "https://link.amazon/B0cNOPSSf",
    "https://link.amazon/B01NX0TlN",
    "https://link.amazon/B0ftoH36E",
    "https://link.amazon/B0dkFjfA3",
    "https://link.amazon/B0a0tvHkS",
    "https://link.amazon/B07depzzr",
    "https://link.amazon/B03cyhQg5",
    "https://link.amazon/B02EBHPWI",
    "https://link.amazon/B0chL8J4f",
    "https://link.amazon/B07hcx1MJ",
    "https://link.amazon/B05Xg8tnW",
    "https://link.amazon/B0bbhCiYt",
    "https://link.amazon/B0bQhkHJG",
    "https://link.amazon/B0fBfEW4y",
    "https://link.amazon/B05U021nf",
    "https://link.amazon/B02kUrPye",
    "https://link.amazon/B00dU4cdJ",
    "https://link.amazon/B0fNvlS87",
    "https://link.amazon/B0f92k9Y4",
    "https://link.amazon/B08qCt3Z1",
    "https://link.amazon/B00p3ikqT",
    "https://link.amazon/B03TZvINd",
    "https://link.amazon/B0acizYZI",
    "https://link.amazon/B022k3QN7",
    "https://link.amazon/B0ayvxfrw",
    "https://link.amazon/B054MhJug",
    "https://link.amazon/B01EXJ9fO",
    "https://link.amazon/B0hcQJIw4",
    "https://link.amazon/B04XfZ1TG",
    "https://link.amazon/B08eS1VU2",
    "https://link.amazon/B04uluq3n",
    "https://link.amazon/B05nKJxcU",
    "https://link.amazon/B0gV0lE3O",
    "https://link.amazon/B0gIDpA70"
]
        ...
        try:
            with opener.open(u, timeout=12) as resp:
                ...
                if title and img_url:
                    ...
                    t_lower = title.lower()
                    if any(k in t_lower for k in ['phone', 'mobile', 'charger', 'cable', 'headphone', 'earbuds', 'laptop', 'smartwatch', 'tv', 'electronics', 'speaker', 'led', 'pro', 'wifi', 'watch', 'camera', 'ups', 'router', 'adapter', 'cable', 'battery', 'memory', 'keyboard', 'mouse']):
                        category = "Technology"
                    elif any(k in t_lower for k in ['shirt', 'pant', 'shoes', 'dress', 'bag', 'fashion', 'wear', 't-shirt', 'wallet', 'kurta', 'suit', 'saree', 'trolley', 'mattress', 'bed', 'sofa', 'pajama', 'nightsuit', 'lungi', 'dupatta', 'sandal', 'heel', 'bangles', 'jewel', 'necklace', 'earring', 'perfume', 'attar']):
                        category = "Lifestyle"
                    elif any(k in t_lower for k in ['kitchen', 'home', 'bottle', 'cookware', 'clean', 'mat', 'light', 'furnishing', 'storage', 'rakhi', 'vacuum', 'juice', 'cloth', 'glass', 'mug', 'cup', 'idol', 'frame', 'pebbles', 'stones', 'trivet', 'towel', 'detergent', 'plant', 'succulent', 'curtain', 'diwan', 'scented', 'candle']):
                        category = "Shopping"
                    elif any(k in t_lower for k in ['sport', 'fit', 'gym', 'cycle', 'ball', 'run', 'yoga', 'paddle', 'racket', 'band', 'racket', 'knee', 'teether', 'game', 'toy', 'spin']):
                        category = "Sports"
                    else:
                        category = "Shopping"
